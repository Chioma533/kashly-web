...
const AchievementSystem = () => {
  ...
  const challenges = [
    ...
    },
    {
      ...
      description: 'Use public transport or walk instead of ride-sharing',
      reward: 75,
      progress: 2,
      maxProgress: 7,
      timeLeft: '5 days',
  ...
  const milestones = [
    {
      ...
      description: 'Successfully tracked expenses for your first month',
      achieved: true,
      points: 200,
      date: '2024-12-28'
    },
    {
      ...
      description: 'Reduced monthly expenses by 10%',
      achieved: true,
      points: 300,
      date: '2025-01-10'
    },
    {
      ...
      description: 'Reach your first $1000 savings milestone',
      achieved: false,
      points: 500,
      progress: 75
    }
          ...
          {badges.map((badge) => (
            ...
            >
              ...
              <div className="text-center">
                ...
                <h3 className={`font-medium mb-1 ${badge.earned ? 'text-foreground' : 'text-muted-foreground'}`}>
                  {badge.name}
                </h3>
        ...
        <div className="space-y-4">
          {milestones.map((milestone) => (
            ...
            >
              ...
              <div className="flex-1">
                <h3 className={`font-medium ${milestone.achieved ? 'text-foreground' : 'text-muted-foreground'}`}>
                  {milestone.title}
                </h3>
